    ...
    <div className={footerCss.footer}>
      <div className={footerCss.innerFooter}>
        <div className={footerCss.sec1}>
          <div className={footerCss.logoBox}>Jigato</div>
        ...
        <div className={footerCss.sec2}>
          <div className={[footerCss.box1, footerCss.box].join(" ")}>
            <div className={footerCss.boxTtl}>ABOUT Jigato</div>
        ...
        <div className={footerCss.sec3}>
          ...
          properties of their respective owners. 2008-2022 © Jigato™ Ltd. All
          rights reserved.
        </div>
      </div>
    </div>
