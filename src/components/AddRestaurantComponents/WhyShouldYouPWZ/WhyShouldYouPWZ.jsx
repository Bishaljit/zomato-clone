  ...
  return (
    <div className={css.outerDiv}>
      <div className={css.innerDiv}>
        <div className={css.title}>Why should you partner with Jigato?</div>
        <div className={css.tagLine}>
          Jigato enables you to get 60% more revenue, 10x new customers and
